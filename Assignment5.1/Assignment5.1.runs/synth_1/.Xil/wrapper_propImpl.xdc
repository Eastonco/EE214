set_property SRC_FILE_INFO {cfile:C:/Users/Eastonco/Documents/EE214/Assignment5.1/Assignment5.1.srcs/constrs_1/new/constraints.xdc rfile:../../../Assignment5.1.srcs/constrs_1/new/constraints.xdc id:1} [current_design]
set_property src_info {type:XDC file:1 line:1 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_L13P_T2_MRCC_35 Schematic=SYSCLK create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 4} [get_ports { clk }];
...
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { Red }]; #IO_L22P_T3_34  Schematic=LD10_R
