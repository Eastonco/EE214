...
HD_PWD='C:/Users/Eastonco/Documents/EE214/Assignment4.4/Assignment4.4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shifters.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shifters.tcl
