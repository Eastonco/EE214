...
HD_PWD='C:/Users/Eastonco/Documents/EE214/Assignment4.4/Assignment4.4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shifters.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shifters.tcl -notrace
