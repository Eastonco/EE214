...
HD_PWD='C:/Users/Eastonco/Documents/EE214/assignment5.3/assignment5.3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log segwrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source segwrapper.tcl -notrace
