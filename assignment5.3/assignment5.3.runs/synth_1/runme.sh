...
HD_PWD='C:/Users/Eastonco/Documents/EE214/assignment5.3/assignment5.3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log segwrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source segwrapper.tcl
